...
export default function ApostadosDetailsPage() {
              ...
              <div className="flex gap-3">
                ...
                {!tournament.deposit_confirmed && (
                  <PrizeDepositDialog tournament={tournament} onSuccess={refetch}>
                    <Button className="h-14 px-8 bg-amber-500 hover:bg-amber-600 text-black font-black italic uppercase rounded-xl shadow-lg shadow-amber-500/20">
                      Pagar Premiação
                    </Button>
                  </PrizeDepositDialog>
                )}
              ...
              <CardContent className="pt-8 px-10 pb-10">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-5xl font-black italic tracking-tighter text-white">
                        R$ {tournament.prize_pool_brl.toFixed(2).replace('.', ',')}
                      </p>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  ...
                  <div className="p-5 rounded-2xl bg-white/2 border border-white/5">
                    ...
                    <p className="text-xl font-black italic text-white mt-1">
                      {tournament.entry_fee_brl > 0
                        ? `R$ ${tournament.entry_fee_brl.toFixed(2).replace('.', ',')}`
                        : "Grátis"}
                    </p>
                  </div>
                  <div className="p-5 rounded-2xl bg-white/2 border border-white/5">
            ...
            <Tabs defaultValue="overview" className="space-y-6">
              ...
              <TabsContent value="chat" className="pt-4">
                {(isParticipant || isOrganizer) ? (
                  ...
                  <div className="py-20 text-center bg-white/2 border border-dashed border-white/5 rounded-[32px]">
                    <Clock className="h-12 w-12 mx-auto mb-4 text-gray-800" />
                    <p className="text-[10px] font-black uppercase tracking-widest text-gray-600">
                      O Chat e Hub estão disponíveis apenas para participantes
                    </p>
                  </div>
                )}
              </TabsContent>
              ...
              <Card className="border-red-500/10 bg-red-500/5 rounded-[32px] overflow-hidden border">
                <CardContent className="p-8">
                  ...
                  <DeleteMiniTournamentDialog
                    tournament={tournament}
                    onSuccess={() => router.push("/apostados")}
                  >
                    <Button
                      variant="ghost"
